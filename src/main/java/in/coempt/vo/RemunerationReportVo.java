...
public class RemunerationReportVo {
    ...
    private String  first_name, last_name, mobile_no, college_code, college_name,  designation,setsCompleted,  teaching_experience, industry_experience, residential_address;
